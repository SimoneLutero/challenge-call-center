...
get_weather() ->
    inets:start(),
    case httpc:request("http://a.openweathermap.org/data/2.5/onecall?lat=44.414165&lon=8.942184&exclude=current,minutely,hourly&appid=dfd99b153f2fcc53ee63bcb1e2d7ec7a") of
        {ok, {{_, 200, _}, _, Body}} ->
